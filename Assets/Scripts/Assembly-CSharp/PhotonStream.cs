...
public class PhotonStream
{
	...
	public object ReceiveNext()
	{
		if (write)
		{
			DConsole.LogError("Error: you cannot read this stream that you are writing!");
			return null;
		}
	...
	public void SendNext(object obj)
	{
		if (!write)
		{
			DConsole.LogError("Error: you cannot write/send to this stream that you are reading!");
		}
		else
		{
