...
public class PickupCamera : Photon.MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		if (!cameraTransform)
		{
			DConsole.Log("Please assign a camera to the ThirdPersonCamera script.");
			base.enabled = false;
		}
		...
		{
			DConsole.Log("Please assign a target to the camera that has a ThirdPersonController script attached.");
		}
