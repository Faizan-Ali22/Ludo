...
public class PickupItem : Photon.MonoBehaviour, IPunObservable
{
	...
	public void PunPickup(PhotonMessageInfo msgInfo)
	{
		...
		{
			DConsole.Log(string.Concat("Ignored PU RPC, cause item is inactive. ", base.gameObject, " SecondsBeforeRespawn: ", SecondsBeforeRespawn, " TimeOfRespawn: ", TimeOfRespawn, " respawn in future: ", (TimeOfRespawn > PhotonNetwork.time).ToString()));
			return;
		}
	...
	{
		DConsole.Log("PunRespawn with Position.");
		PunRespawn();
