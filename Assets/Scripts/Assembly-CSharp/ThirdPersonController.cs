...
public class ThirdPersonController : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		if (!_animation)
		{
			DConsole.Log("The character you would like to control doesn't have animations. Moving her might look weird.");
		}
		if (!idleAnimation)
		{
			_animation = null;
			DConsole.Log("No idle animation found. Turning off animations.");
		}
		if (!walkAnimation)
		{
			_animation = null;
			DConsole.Log("No walk animation found. Turning off animations.");
		}
		if (!runAnimation)
		{
			_animation = null;
			DConsole.Log("No run animation found. Turning off animations.");
		}
		if (!jumpPoseAnimation && canJump)
		{
			_animation = null;
			DConsole.Log("No jump animation found and the character has canJump enabled. Turning off animations.");
		}
	}
