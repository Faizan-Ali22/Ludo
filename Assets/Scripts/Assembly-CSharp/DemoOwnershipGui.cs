...
public class DemoOwnershipGui : MonoBehaviour
{
	...
	public void OnOwnershipRequest(object[] viewAndPlayer)
	{
		...
		DConsole.Log(string.Concat("OnOwnershipRequest(): Player ", photonPlayer, " requests ownership of: ", photonView, "."));
	...
	public void OnOwnershipTransfered(object[] viewAndPlayers)
	{
		...
		DConsole.Log(string.Concat("OnOwnershipTransfered for PhotonView", photonView.ToString(), " from ", photonPlayer2, " to ", photonPlayer));
	}
