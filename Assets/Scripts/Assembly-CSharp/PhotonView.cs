...
public class PhotonView : Photon.MonoBehaviour
{
	...
	protected internal void OnDestroy()
	{
		if (!removedFromLocalViewList)
		{
			...
			{
				DConsole.Log("PUN-instantiated '" + base.gameObject.name + "' got destroyed by engine. This is OK when loading levels. Otherwise use: PhotonNetwork.Destroy().");
			}
		}
	}
	...
	protected internal void DeserializeComponent(Component component, PhotonStream stream, PhotonMessageInfo info)
	{
		...
		{
			DConsole.LogError("Type of observed is unknown when receiving.");
		}
	}
	...
	protected internal void SerializeComponent(Component component, PhotonStream stream, PhotonMessageInfo info)
	{
		...
		{
			DConsole.LogError("Observed type is not serializable: " + component.GetType());
		}
	}
	...
	protected internal void ExecuteComponentOnSerialize(Component component, PhotonStream stream, PhotonMessageInfo info)
	{
		...
		else
		{
			...
			if (!m_OnSerializeMethodInfos.TryGetValue(component, out value))
			{
				...
				{
					DConsole.LogError("The observed monobehaviour (" + component.name + ") of this PhotonView does not implement OnPhotonSerializeView()!");
					value = null;
				}
