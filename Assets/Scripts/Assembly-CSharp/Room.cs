...
public class Room : RoomInfo
{
	...
	public new bool IsOpen
	{
		...
		set
		{
			...
			{
				DConsole.LogWarning("Can't set open when not in that room.");
			}
	...
	public new bool IsVisible
	{
		...
		set
		{
			if (!Equals(PhotonNetwork.room))
			{
				DConsole.LogWarning("Can't set visible when not in that room.");
			}
	...
	public new int MaxPlayers
	{
		...
		set
		{
			if (!Equals(PhotonNetwork.room))
			{
				DConsole.LogWarning("Can't set MaxPlayers when not in that room.");
			}
			if (value > 255)
			{
				DConsole.LogWarning("Can't set Room.MaxPlayers to: " + value + ". Using max value: 255.");
				value = 255;
			}
	...
	public int PlayerTtl
	{
		...
		set
		{
			if (!Equals(PhotonNetwork.room))
			{
				DConsole.LogWarning("Can't set PlayerTtl when not in a room.");
			}
	...
	public int EmptyRoomTtl
	{
		...
		set
		{
			if (!Equals(PhotonNetwork.room))
			{
				DConsole.LogWarning("Can't set EmptyRoomTtl when not in a room.");
			}
