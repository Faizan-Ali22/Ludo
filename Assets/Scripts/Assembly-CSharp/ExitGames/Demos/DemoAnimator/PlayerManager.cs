...
namespace ExitGames.Demos.DemoAnimator
{
	public class PlayerManager : PunBehaviour, IPunObservable
	{
		...
		public void Awake()
		{
			if (Beams == null)
			{
				DConsole.LogError("<Color=Red><b>Missing</b></Color> Beams Reference.", this);
			}
			else
			{
		...
		public void Start()
		{
			...
			{
				DConsole.LogError("<Color=Red><b>Missing</b></Color> CameraWork Component on player Prefab.", this);
			}
			...
			{
				DConsole.LogWarning("<Color=Red><b>Missing</b></Color> PlayerUiPrefab reference on player Prefab.", this);
			}
