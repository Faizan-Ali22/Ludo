...
namespace GoogleMobileAds.iOS
{
	internal class Externs
	{
		...
		[DllImport("__Internal")]
		internal static extern void GADUInitializeWithCallback(IntPtr mobileAdsClient, MobileAdsClient.GADUInitializationCompleteCallback callback);
		...
		[DllImport("__Internal")]
		internal static extern void GADURequestRewardBasedVideoAd(IntPtr bannerView, IntPtr request, string adUnitId);
		...
		[DllImport("__Internal")]
		internal static extern void GADURequestRewardedAd(IntPtr rewardedAd, IntPtr request);

		[DllImport("__Internal")]
		internal static extern void GADUSetRewardedAdCallbacks(IntPtr rewardedAd, RewardedAdClient.GADURewardedAdDidReceiveAdCallback adReceivedCallback, RewardedAdClient.GADURewardedAdDidFailToReceiveAdWithErrorCallback adFailedToLoadCallback, RewardedAdClient.GADURewardedAdDidFailToShowAdWithErrorCallback adFailedToShowCallback, RewardedAdClient.GADURewardedAdDidOpenCallback didOpenCallback, RewardedAdClient.GADURewardedAdDidCloseCallback didCloseCallback, RewardedAdClient.GADUUserEarnedRewardCallback userEarnedRewardCallback, RewardedAdClient.GADURewardedAdPaidEventCallback paidEventCallback);
		...
		[DllImport("__Internal")]
		internal static extern string GADUNativeCustomTemplateAdTemplateID(IntPtr nativeCustomTemplateAd);

		[DllImport("__Internal")]
		internal static extern string GADUNativeCustomTemplateAdImageAsBytesForKey(IntPtr nativeCustomTemplateAd, string key);

		[DllImport("__Internal")]
		internal static extern string GADUNativeCustomTemplateAdStringForKey(IntPtr nativeCustomTemplateAd, string key);

		[DllImport("__Internal")]
		internal static extern void GADUNativeCustomTemplateAdRecordImpression(IntPtr nativeCustomTemplateAd);

		[DllImport("__Internal")]
		internal static extern void GADUNativeCustomTemplateAdPerformClickOnAssetWithKey(IntPtr nativeCustomTemplateAd, string assetName, bool customClickAction);

		[DllImport("__Internal")]
		internal static extern IntPtr GADUNativeCustomTemplateAdAvailableAssetKeys(IntPtr nativeCustomTemplateAd);

		[DllImport("__Internal")]
		internal static extern int GADUNativeCustomTemplateAdNumberOfAvailableAssetKeys(IntPtr nativeCustomTemplateAd);

		[DllImport("__Internal")]
		internal static extern void GADUSetNativeCustomTemplateAdUnityClient(IntPtr nativeCustomTemplateAd, IntPtr nativeCustomTemplateClient);
