...
namespace GoogleMobileAds.Common
{
	internal class Utils
	{
		public static void CheckInitialization()
		{
			...
			{
				DConsole.Log("You intitialized an ad object but have not yet called MobileAds.Initialize(). We highly recommend you call MobileAds.Initialize() before interacting with the Google Mobile Ads SDK.");
			}
