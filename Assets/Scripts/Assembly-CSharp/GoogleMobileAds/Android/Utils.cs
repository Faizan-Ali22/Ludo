	...
	internal class Utils
	{
		...
		public static AndroidJavaObject GetAdSizeJavaObject(AdSize adSize)
		{
			...
			case AdSize.Type.SmartBanner:
				return new AndroidJavaObject("com.google.android.gms.ads.AdSize", -1, -2).GetStatic<AndroidJavaObject>("SMART_BANNER");
			case AdSize.Type.AnchoredAdaptive:
			{
				AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.google.android.gms.ads.AdSize");
				...
				case Orientation.Landscape:
					return androidJavaClass.CallStatic<AndroidJavaObject>("getLandscapeBannerAdSizeWithWidth", new object[2] { androidJavaObject, adSize.Width });
				case Orientation.Portrait:
					return androidJavaClass.CallStatic<AndroidJavaObject>("getPortraitBannerAdSizeWithWidth", new object[2] { androidJavaObject, adSize.Width });
				case Orientation.Current:
					return androidJavaClass.CallStatic<AndroidJavaObject>("getCurrentOrientationBannerAdSizeWithWidth", new object[2] { androidJavaObject, adSize.Width });
				default:
		...
		public static AndroidJavaObject GetAdRequestJavaObject(AdRequest request)
		{
			...
			androidJavaObject.Call<AndroidJavaObject>("setRequestAgent", new object[1] { "unity-5.0.0" });
