...
namespace GoogleMobileAds.Android
{
	internal class InitializationStatusClient : IInitializationStatusClient
	{
		...
		public AdapterStatus getAdapterStatusForClassName(string className)
		{
			...
			AndroidJavaObject androidJavaObject2 = new AndroidJavaClass("com.google.android.gms.ads.initialization.AdapterStatus$State").GetStatic<AndroidJavaObject>("READY");
			return new AdapterStatus(androidJavaObject.Call<AndroidJavaObject>("getInitializationState", Array.Empty<object>()).Call<bool>("equals", new object[1] { androidJavaObject2 }) ? AdapterState.Ready : AdapterState.NotReady, description, latency);
		}
