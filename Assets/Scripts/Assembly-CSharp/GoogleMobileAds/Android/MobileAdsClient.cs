...
namespace GoogleMobileAds.Android
{
	public class MobileAdsClient : AndroidJavaProxy, IMobileAdsClient
	{
		...
		public void Initialize(string appId)
		{
			...
			new AndroidJavaClass("com.google.android.gms.ads.MobileAds").CallStatic("initialize", androidJavaObject, appId);
		}
		...
		public void Initialize(Action<InitializationStatus> initCompleteAction)
		{
			...
			AndroidJavaObject androidJavaObject = new AndroidJavaClass("com.unity3d.player.UnityPlayer").GetStatic<AndroidJavaObject>("currentActivity");
			new AndroidJavaClass("com.google.android.gms.ads.MobileAds").CallStatic("initialize", androidJavaObject, this);
		}
